...
function setup() {
	...
	leftSide = new Ground(1100,550,10,166);
	rightSide = new Ground(1270,550,10,166);
...
image(paperImg,ball.position.x,ball.position.y,90,90);

	// use image() command to add dustbin image in the canvas.
	image(dustbinImg,1185, 565, 200,200);
